...
{
  "$end", "error", "$undefined", "sMas", "sMenos", "sPor", "sPuntoComa",
  "sAbreParent", "sCierraParent", "tImprimir", "valNumero", "$accept", "S",
  "E", YY_NULLPTR
};
#endif
...
#line 77 "sintactico.y" /* yacc.c:1646  */
    {
            ...
            nodo *nuevo=new nodo("*");
            nuevo->insertarHijo((yyvsp[-2].NODO)->Padre);
            nuevo->insertarHijo((yyvsp[0].NODO)->Padre);

            nuevo->multiplicar((yyvsp[-2].NODO)->Padre->valor,(yyvsp[0].NODO)->Padre->valor);
...
#line 89 "sintactico.y" /* yacc.c:1646  */
    {
            ...
            nuevo->sumar((yyvsp[-2].NODO)->Padre->valor,(yyvsp[0].NODO)->Padre->valor);
...
#line 101 "sintactico.y" /* yacc.c:1646  */
    {
            ...
            nodo *nuevo=new nodo(QString::fromStdString((yyvsp[0].TEXT)));
            nuevo->setValor(std::atoi((yyvsp[0].TEXT)));
